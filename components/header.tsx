...
export function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 transition-all duration-300 border-b border-white/10 backdrop-blur-md bg-black/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <nav className="absolute top-full left-0 right-0 bg-black/90 backdrop-blur-xl border-b border-white/10 md:hidden">
            <div className="px-4 py-4 space-y-4">
              <Link href="/services" className="block text-white/80 hover:text-orange-400">
                Services
              </Link>
              <Link href="/industries" className="block text-white/80 hover:text-orange-400">
                Industries
              </Link>
              <Link href="/portfolio" className="block text-white/80 hover:text-orange-400">
                Portfolio
              </Link>
              <Link href="/blog" className="block text-white/80 hover:text-orange-400">
                Case Studies
              </Link>
              <Button
                onClick={handleLetsTalk}
