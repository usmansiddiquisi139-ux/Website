    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 md:left-auto md:right-8 md:bottom-8 z-50 max-w-md backdrop-blur-md bg-white/70 text-white rounded-2xl shadow-lg border border-slate-200 p-6"
        >
          ...
          <div className="flex justify-end gap-3">
            <button
              ...
              className="px-4 py-2 rounded-lg border border-slate-300 text-sm text-white/80 hover:bg-slate-100 transition"
            >
              Decline
            </button>
            <button
