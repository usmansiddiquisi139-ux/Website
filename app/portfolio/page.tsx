            ...
            {caseStudies.map((study) => (
              <Link key={study.slug} href={`/portfolio/${study.slug}`}>
                <div className="h-full p-8 rounded-lg border border-orange-500/30 bg-orange-500/10 backdrop-blur-sm hover:border-orange-400 hover:bg-orange-500/20 transition cursor-pointer group">
                  ...
                  <p className="text-orange-400 font-semibold group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-orange-500 group-hover:to-red-500 group-hover:text-transparent transition-all duration-300">
                    {study.outcome}
                  </p>
                </div>
              </Link>
